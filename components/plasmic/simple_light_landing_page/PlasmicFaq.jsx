...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: t69hcxn8CL3k/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___6OnPu)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__zEqv)}>
          <div className={classNames(projectcss.all, sty.freeBox__df4Hr)}>
            {renderPlasmicSlot({
